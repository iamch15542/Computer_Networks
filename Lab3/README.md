...
![/img/img3.png](../Lab3/img/img3.png)

### controller.py forwarding by this picture

![/img/img8.png](../Lab3/img/img4.png)
...
* SimpleController.py
	...
	![/img/img2.png](../Lab3/img/img2.png)

* controller.py

	![/img/img8.png](../Lab3/img/img8.png)
...
3. Mininet Topology
	...
	2. 再依照topo/topo.png來新增bandwidth, delay, and loss rate上去
		...
		![/src/topo/topo.jpg](../Lab3/src/topo/topo.jpg)
	3. 先在終端機跑topo.py
	...
	5. 出現![/img/img5.png](../Lab3/img/img5.png)

		表示你的 controller.py 有問題，需要進行修改。
	6. 出現![/img/img6.png](../Lab3/img/img6.png)
...
4. Ryu Controller
	...
	2. 再依照![/img/img4.png](../Lab3/img/img4.png)來修改controller.py
...
7. Compare the differences between the iPerf results of `SimpleController.py` and `controller.py` in detail.
	...
	result1 ![/img/img9.png](../Lab3/img/img9.png)
	
	result2 ![/img/img10.png](../Lab3/img/img10.png)
